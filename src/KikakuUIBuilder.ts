...
namespace KIKAKU {
	...
	class MultipleParameter extends Parameter {
	...
	class TextsParameter extends MultipleParameter {
		protected _uis: (EditText|StaticText)[] = [];
		protected getCreationProperties(): any {
			return {};
		}
		buildParameter() {
	...
	class NumbersParameter extends MultipleParameter {
	...
	class CheckboxesParameter extends MultipleParameter {
		protected _uis: Checkbox[] = [];
	...
	class ColorsParameter extends MultipleParameter {
		protected _uis: Button[] = [];
	...
	class ItemsParameter extends MultipleParameter {
		protected _uis: (DropDownList|ListBox)[] = [];
